...
建物寸法:
  全体幅: 8400mm
  全体奥行: 10000mm
    - 本体部分: 左側のみ、Y座標7000-10000mm（高さ3000mm）
...
**高さ境界（内部境界）**: Y = 7000mm で本体と下屋の高さが変わる（ただしL字型）
...
内部境界（下屋ライン、L字型）:
  ...
  edge10: 入隅縦辺（下向き） - (3000,7000) → (3000,10000) - 3000mm
  edge9b: 右側横辺 - (3000,7000) → (8400,7000) - 5400mm
